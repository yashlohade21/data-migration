...
_KEYWORD_MAP = {
    ...
    "contract_type": ("employment_type", 0.88),
    "emp_type": ("employment_type", 0.90),
    "salary": ("salary", 1.0),
    "annual_ctc": ("salary", 0.90),
    "ctc": ("salary", 0.90),
    "annual_salary": ("salary", 0.95),
    "monthly_pay": ("salary", 0.80),
    "compensation": ("salary", 0.85),
    "hourly_rate": ("salary", 0.40),
    "mgr": ("manager_email", 0.75),
    "manager": ("manager_email", 0.80),
}
